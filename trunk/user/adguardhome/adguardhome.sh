...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://mirror.ghproxy.com/https://github.com/MeIsReallyBa/padavan-4.4/blob/main/trunk/user/adguardhome/AdGuardHome
